...
הגדרת סוג ה-Workspace מתבצעת בשתי רמות משלימות:

### 1. קובץ הגדרה workspace.yaml בתיקיית docs של ה-Workspace
...
### 2. הצגה ב-README בתיקיית docs של ה-Workspace

ולציין בראש קובץ ה-README של ה-Workspace את הפרטים הבאים:
...
תרשים זה מתאר Workspace שהוחלט לייצר לו מסמכי docs, כמו System Workspace
